...
<div class="box form">
    ...
    <div class="block_input">
        <div class="block">
            <input type="text" id="inputUser" placeholder="Поиск групп">
            <select id="selectUser" multiple="true" class="user_1 select">
                <c:forEach items="${groupsForGroup}" var="group">
    ...
    <form class="block_input_form" method = "post" action="${pageContext.request.contextPath}/servlet/searchUserWEB/add/addGroup">
        <select id="select_1" multiple="true" class="user_2 select_form" name="selectedGroupForGroup" required></select>
        <select id="select_2" multiple="true" class="product_2 select_form" name="selectedProductForGroup" required></select>
        <select id="select_3" multiple="true" class="role_2 select_form" name="selectedRoleForGroup" required></select>
        <button id="js-button-add" class="button_add">
            <div id="push" style="display: none;" class="spinner"></div>
            <span id="span">Добавить группы </span>
        </button>
    </form>
